...
**능동형 AI/ML 데일리 다이제스트. 다섯 계열의 소스에서 콘텐츠를 모아 LLM으로 순위를 매기고, 한국어 에디토리얼 다이제스트를 써서 Slack과 Threads로 보낸다. Slack 멘션으로 작동하는 딥 리서치 에이전트는 어떤 주제든 웹과 논문과 커뮤니티를 조사해 페르소나 보이스의 인용 기반 리포트를 게시한다.**
